...
public class CommandBuilderTest {
	...
	public void testCommandBuilderAll() {
		List<Command> allCommands = CommandBuilder.buildCommands(GameConstant.COMMAND_ACHAT, GameConstant.COMMAND_TIRAGE, GameConstant.COMMAND_GAGNANTS, GameConstant.COMMAND_EXIT);
	...
	public void testCommandBuilderFault() {
		List<Command> allCommands = CommandBuilder.buildCommands("Wrong");
